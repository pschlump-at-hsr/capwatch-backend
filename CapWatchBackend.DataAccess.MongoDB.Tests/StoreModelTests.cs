...
namespace CapWatchBackend.DataAccess.MongoDB.Tests {
  ...
  public class StoreModelTests {
    ...
    public void TestAddStore() {
      ...
      sm.GetStore(res.Id).Name.Should().Be("Botanischer Garten der Universität Bern");
    }

    [Fact]
    public void TestGetStores() {
      List<Store> stores = new List<Store>();
      stores.Add(new Store { Name = "Ikea", Secret = new Guid("02a4299e-f472-41d1-9468-df369bd30872"), Street = "Zürcherstrasse 460", ZipCode = "9015", City = "St. Gallen", CurrentCapacity = 135, MaxCapacity = 201 });
      stores.Add(new Store { Name = "Zoo Zürich", Secret = new Guid("9e573805-f5b4-49bb-bbaf-844b44ea3942"), Street = "Zürichbergstrasse 221", ZipCode = "8044", City = "Zürich", CurrentCapacity = 487, MaxCapacity = 1125 });
      ...
      stores.Add(new Store { Name = "Alpamare", Secret = new Guid("9f1fb7fb-5e9e-4ebd-90d7-30f82ebec8e7"), Street = "Gwattstrasse 12", ZipCode = "8808", City = "Pfäffikon", CurrentCapacity = 152, MaxCapacity = 612 });
      sm.AddStores(stores);
